...
const Home = () => {
    ...
    const [showModal, setShowModal] = useState(document.cookie ? !document.cookie : false)

    useEffect(() => {
        setTimeout(function () {
            console.log('Modal.show()');
            setShowModal(!document.cookie)
    ...
    return (
        <main>
            <div className={`${showModal ? "opacity-container" : ""}`}>
                            ...
                            .map((item, idx) => {
                                ...
                                return (
                                    <article className="card" key={idx}>
                                        <a href={`/product/${item.product_id}`} onClick={() => {
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className="card-price">
                                                    <span className="true-price">{cheapestPrice.toLocaleString()} đ</span>
